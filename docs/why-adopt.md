...
The [literature matrix](evidence-base.md) links original papers to the research and assessment ideas below and states where their evidence stops.
...
The motivation for explicit research metadata and linked artifacts is grounded in the [FAIR principles](https://doi.org/10.1038/sdata.2016.18) and [RO-Crate](https://doi.org/10.3233/DS-210053). Neither paper evaluates this format.
...
The [AI Assessment Scale](https://doi.org/10.53761/q3azde36) offers a policy framework for specifying permitted AI use, with a [single-context pilot](https://doi.org/10.14742/ajet.9434). A [randomized mathematics study](https://doi.org/10.1073/pnas.2422633122) illustrates why assisted task performance should be separated from unassisted learning outcomes. [Research on AI-text detectors](https://doi.org/10.1016/j.patter.2023.100779) identifies fairness problems with using such detectors in evaluation. None of these studies validates PROVENANCE.
